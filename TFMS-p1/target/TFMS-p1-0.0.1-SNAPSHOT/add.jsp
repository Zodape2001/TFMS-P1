...
<html lang="en">
  <head>
    ...
    <title>CodeTech - Add Trainer</title>
    ...
    <script src="https://kit.fontawesome.com/6ce3a30560.js" crossorigin="anonymous"></script>
  ...
  <body>
    ...
    <header id="header" class="fixed-top">
      <div class="container d-flex align-items-center">
        <h1 class="logo me-auto"><a href="admin.jsp">CodeTech</a></h1>
                ...
                <div class="card-body p-md-5">
                  <div class="row justify-content-center">
                    <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                      ...
                      <form class="mx-1 mx-md-4" action="/InsertData" method="post">
                    ...
                    >
                      <img
                        src="./assets/img/add-animate.svg"
                        class="img-fluid"
                        alt="Sample image"
                      />
                    </div>
